...
const state_URL = 'https://api.airvisual.com/v2/states?country=India&key='+API_KEY;
const city_URL ="https://api.airvisual.com/v2/cities?state="+state_name+"&country=India&key="+API_KEY;
const detail_url = "https://api.airvisual.com/v2/city?city="+city_name+"&state="+state_name+"&country=India&key="+API_KEY;
